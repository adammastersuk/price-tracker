...
function mapToTrackedProductRow(
  ...
  const competitorListings: CompetitorListing[] = sortedComps.map((comp) => ({
    ...
    competitorStockStatus: (comp.competitor_stock_status as CompetitorListing["competitorStockStatus"]) ?? (comp.competitor_url ? "Unknown" : "Not tracked"),
  ...
  return {
    ...
    competitorStockStatus: summaryListing?.competitorStockStatus ?? "Not tracked",
